  ...
  execute(client, message) { 
    message.channel.send(
      new Discord.MessageEmbed()
        .setTitle("Commandes Source Images")
        .setDescription("• `sauce`[+ image / URL] *gif non inclus : rechercher la provenance d'une image (Hentai/Scan/Animes compris)\n• `whatanime`[+ image (non URL)] : rechercher un anime à partir d'une image")
        .setColor("#f55185        ") 
