  ...
  execute(client, message, args){
    message.channel.send(
      new Discord.MessageEmbed()
        ...
        .setAuthor(
          "ala89 **bonjour**",
          "https://cdn.discordapp.com/attachments/718476721418141728/719563110154764298/logo.png",
          "https://google.fr"
        )
        .setImage(
          "https://cdn.discordapp.com/attachments/718476721418141728/719563122960236644/thumb.png"
        )
        .setThumbnail(
          "https://cdn.discordapp.com/attachments/718476721418141728/719563110154764298/logo.png"
        )
        .setFooter(
          "Mon bot perso **bonjour**",
          "https://cdn.discordapp.com/attachments/718476721418141728/719563110154764298/logo.png"
        )
        .setTimestamp()
